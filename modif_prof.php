...
if(isset($_POST['valider'])){
	header("refresh:3;url=accueilProf?page=0");
...
$sql ="SELECT Produit.id_produit as id, Produit.CodeAPP as code, Produit.fournisseur as fournisseur, Produit.quantiteUtil as qteUtil, Produit.quantiteCommande as qteCommande, Produit.nom as nom, Produit.lien as lien, Produit.description as description, Produit.puTTC as puTTC, Produit.montantTTC as montantTTC, Produit.document as doc, Produit.id_demande as id_demande FROM Produit WHERE Produit.id_produit ='".$_POST['produit']."'";
$result = mysql_query($sql) or die("Requête invalide: ". mysql_error()."\n".$sql);
...
echo "<form method='post' action ='prof_modif_2.php'>";
